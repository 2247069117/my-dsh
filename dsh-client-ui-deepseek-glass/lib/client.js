...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    if (document.getElementById("dsh-deepseek-glass-css") === null) {
      var styleTag = document.createElement("style");
      styleTag.id = "dsh-deepseek-glass-css";
 ...
 *   背景引擎设置（极光/鲸鱼/星座/鼠标）在 dsh-client-ui-deepseek-bg 插件。
 *   由 scripts/build.mjs 拼接进 lib/client.js 的工厂闭包。
 * ===================================================================== */
  ...
  function BgSettingsSection() {
    ...
    return h("div", { className: "dsh-bg-settings" },
      ...
      h("div", { className: "dsh-bg-foot" },
        ...
        h("span", { className: "dsh-bg-note" }, "v1.0.0 · 即时生效并自动保存")));
  }
...
function initShell(shared) {
  ...
  function startDiagPanel() {
    ...
    function render() {
      collect();
      panel.textContent = [
        "dsh-client-ui-deepseek-glass v1.0.0 diagnostics",
        "theme: " + diag.theme,
        "body bg: " + diag.bodyBg,
        "html bg: " + diag.htmlBg,
 ...
 *   背景引擎启动（极光/鲸鱼/星座）在 dsh-client-ui-deepseek-bg 插件。
 *   由 scripts/build.mjs 拼接进 lib/client.js 的工厂闭包。
 * ------------------------------------------------------------------ */
