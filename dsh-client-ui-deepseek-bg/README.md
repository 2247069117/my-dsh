...
**界面皮肤层**（玻璃拟态 / Border Beam / Thinking Orbs / 任务清单 Pulse / 发送按钮微动效）已在 `dsh-client-ui-deepseek-glass` 插件（v1.13.0 起拆分），两插件配合使用还原完整效果。
...
> 微动效移至新插件 `dsh-client-ui-deepseek-glass`，本插件仅保留背景引擎四项。
