...
export declare const LS_AI_ENABLED = "dsh-chat-tidy:aiEnabled";
export declare const LS_BING_ENABLED = "dsh-chat-tidy:bingEnabled";
export declare const LS_BASE_URL = "dsh-chat-tidy:baseUrl";
export declare const LS_MODEL = "dsh-chat-tidy:model";
