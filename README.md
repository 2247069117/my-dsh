...
| [@lynn123411/dsh-workspace-tree](./plugins/dsh-workspace-tree) | `dsh.bundle` + `dsh.client/web` | 工作区树：左侧栏工作区从单层升级为多级文件夹树——文件夹任意嵌套、会话可归入任意文件夹，附带新建/重命名/删除/移动管理 | `dsh plugin --profile web add @lynn123411/dsh-workspace-tree` |
